...
关键行为：
- 启动后暴露 16 个 MCP 工具：breath/breath_search/breath_advanced/hold/grow/source_read/
  trace/anchor/release/pulse/plan/letter_write/letter_lock_update/letter_read/dream/I
  与旧客户端兼容别名 introspect；每个入口
